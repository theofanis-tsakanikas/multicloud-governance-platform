...
locals {
  ...
  # Federated (foreign) catalogs: strip schemas (auto-discovered from the source DB;
  # creating databricks_schema on a foreign catalog fails). Schema grants → dbx_mssql_grants.
...
inputs = {
  ...
  azure_storage_account_name = dependency.foundation.outputs.adls_account_name
