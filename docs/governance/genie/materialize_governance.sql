...
INSERT INTO platform_governance.catalog.objects (cloud, domain, object_type, name, classification, owner, catalog_type) VALUES
  ...
  ('AZURE', 'supply_chain', 'schema', 'supplies_azure.gold', 'internal', NULL, 'MANAGED'),
...
INSERT INTO platform_governance.catalog.access_matrix (cloud, domain, object_type, object, principal, privileges, classification, reads_data) VALUES
  ...
  ('AZURE', 'supply_chain', 'schema', 'supplies_azure.gold', 'data_engineers', 'USE_SCHEMA, CREATE_TABLE, SELECT, MODIFY', 'internal', TRUE),
  ('AZURE', 'supply_chain', 'schema', 'supplies_azure.gold', 'analysts', 'USE_SCHEMA, SELECT', 'internal', TRUE),
  ('AZURE', 'supply_chain', 'schema', 'supplies_azure.gold', 'business_users', 'USE_SCHEMA, SELECT', 'internal', TRUE),
  ('AZURE', 'supply_chain', 'schema', 'supplies_azure.gold', 'metastore_admins', 'ALL_PRIVILEGES', 'internal', FALSE),
