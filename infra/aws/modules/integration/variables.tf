...
variable "is_private_connection" { type = bool; default = false }
variable "databricks_host" { type = string }
variable "dbx_account_id" { type = string }
variable "spn_client_id" { type = string; sensitive = true }
variable "spn_client_secret" { type = string; sensitive = true }
variable "vpc_id" { type = string }
variable "subnet_ids" { type = list(string) }
variable "ecs_security_group_id" { type = string }
variable "rds_security_group_id" { type = string }
variable "ncc_id" { type = string; default = null }
