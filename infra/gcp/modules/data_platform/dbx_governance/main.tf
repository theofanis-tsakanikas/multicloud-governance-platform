...
locals {
  ...
  # Enrich catalog data with ready-to-use GCS URIs
  enriched_catalogs = {
...
### 1. GCP External Locations Module
...
module "catalog" {
  ...
  # Pass full lists of schema/volume grants; the module filters internally 
