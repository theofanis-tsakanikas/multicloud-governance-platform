...
variable "azure_storage_account_name" {
  description = "The name of the Azure Storage Account (ADLS Gen2)"
  type        = string
}
...
variable "managed_storage_container" {
  type        = string
  description = "The default Azure container used for managed catalogs if not specified at catalog level."
}
